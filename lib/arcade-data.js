...
export const ARCADE = [
  ...
  },
  {
    ...
    episodes: [
      {
        id: "ep235", ep: "EP235", title: "Family", current: true, cover: "/covers/sentence-builder-ep235.png",
        content: {
      ...
      {
        id: "ep234", ep: "EP234", title: "Morning Routine", current: false, cover: "/covers/sentence-builder-ep234.png",
        content: {
          intro: "Tap the words into the right order to build each sentence. Hear it on every win.",
          sentences: [
            { text: "Before my routine, I felt scattered every morning.", phrase: "scattered",  color: "#f6479a" },
      ...
      {
        id: "ep232", ep: "EP232", title: "Manage Your Time", current: false, cover: "/covers/sentence-builder-ep232.png",
        content: {
          intro: "Tap the words into the right order to build each sentence. Hear it on every win.",
          sentences: [
            { text: "Don't let the whole morning slip away.",        phrase: "slip away",        color: "#f6479a" },
      ...
      {
        id: "ep231", ep: "EP231", title: "Maya's Tuesday", current: false, cover: "/covers/sentence-builder-ep231.png",
        content: {
          intro: "Tap the words into the right order to build each sentence. Hear it on every win.",
          sentences: [
            { text: "It was a really eventful day.",               phrase: "eventful",     color: "#f6479a" },
